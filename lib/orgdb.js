...
(function(){
    ...
    OrgDB.prototype.add = function(file) {
        this.genOrg(file);
    }

    OrgDB.prototype.reload = function(source) {
        this.data = {
            categories: {},
            recent: [],
            orgs: {},
    ...
    OrgDB.prototype.save = function() {
        ...
        for(var i in this.archives) {
            keys.push(i);
            this.archives[i].sort(function(a, b) {return b.date > a.date});
        }
